...
public class Example4Resource {
    ...
    public Response getSampleEvent() throws IOException {
        ...
        Event event = FileHelper.readSingleEvent("/Users/AnneXie/Documents/Columbia/second year/engineering essentials/EngineeringEssentials/techCurriculum/services/EngineeringEssentialsServices/data/single-event.json");
